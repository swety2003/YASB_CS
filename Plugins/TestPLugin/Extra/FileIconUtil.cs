...
{
    internal static IImage GetImgByFile(string file)
    {
        IImage? ico;
        ...
        ico = ico_bmp.ConvertToAvaloniaBitmap();
        return ico;
    }
    ...
    private class extracticon
    {
        ...
        internal static void DrawImage(IImageList iImageList, IntPtr hdc, int index, int x, int y,
